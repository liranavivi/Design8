...
namespace FlowOrchestrator.BaseProcessor.Application.Extensions;

/// <summary>
/// Extension methods for Activity to add common tags
/// Following EntitiesManager.Api patterns for telemetry enrichment
/// </summary>
public static class ActivityExtensions
{
    ...
    /// <summary>
    /// Sets error tags on an activity (following EntitiesManager.Api patterns)
    /// </summary>
    ...
    /// </summary>
    public static Activity? SetMessageTags(this Activity? activity, string messageType, string consumerType, string? correlationId = null)
    {
        activity?
