...
/// Following EntitiesManager.Api tagging conventions
/// </summary>
public static class ActivityTags
{
    // Entity tags (following EntitiesManager.Api patterns)
    ...
    public const string OrchestratedFlowEntityId = "orchestrated_flow.id";
    ...
    // Cache tags (following EntitiesManager.Api patterns)
